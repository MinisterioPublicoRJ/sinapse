...
_LOG_ACESSO = _MONGO_CLIENT[_COLLECTION_MONGO].log_acesso
_LOG_LOGIN = _MONGO_CLIENT[_COLLECTION_MONGO].log_login
_AUTH_MPRJ = config('AUTH_MPRJ')
_USERINFO_MPRJ = config('USERINFO_MPRJ')

_IMAGENS = _MONGO_CLIENT[_COLLECTION_MONGO].imagens
